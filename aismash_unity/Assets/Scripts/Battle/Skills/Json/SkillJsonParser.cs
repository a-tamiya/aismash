    ...
    public static class SkillJsonParser
    {
        ...
        static CharacterVoiceProfile ConvertVoiceProfile(CharacterVoiceJsonRaw raw)
        {
            ...
            return new CharacterVoiceProfile
            {
                ...
                voiceStyle = raw.voice_style,
                voiceVariant = raw.voice_variant,
                qualityVersion = raw.quality_version,
                generationId = raw.voice_generation_id,
        ...
        static void ClampGrabThrow(CharacterData data)
        {
            ...
            data.throwParameters.down_damage = Mathf.Clamp(data.throwParameters.down_damage, 6f, 12f);
            ...
            data.throwParameters.down_knockback = Mathf.Clamp(data.throwParameters.down_knockback, 5f, 12f);
        }
