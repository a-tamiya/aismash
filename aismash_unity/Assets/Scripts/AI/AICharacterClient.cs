...
- 【新アクション types】
  counter: duration=カウンター受付秒(0.1〜1.5)、damage_override=カウンター反撃ダメージ。発動中に攻撃を受けると自動で反撃。黄色く光る
  reflector: duration=反射受付秒(0.2〜3.0)。発動中は飛び道具を跳ね返す。ピンク色に光る
  summon: duration=召喚体の寿命(1〜6)、power=パトロール速度(0.5〜5)、spawn_x/y=出現位置、damage_override=接触ダメージ。召喚体が自動でパトロールしながら攻撃する
- 【area_hitbox の形状】area_hitboxにshapeフィールドを追加可能:
  shape: ""box""(default/四角)、""cone""(前方扇形・幅広)、""ring""(自分の周囲円形)
- 【派生技 follow_up_actions】スキルJSON最上位に追加:
  follow_up_actions: [...actionリスト...]  ← メインアクションがヒット後に追加入力で発動する派生アクション
  follow_up_window: 0.3〜1.0  ← ヒット後の受付時間(秒)
  例: 前転コンボ技で1段目ヒット後に2段目を派生できる
- 【チャージ技】スキルJSON最上位に追加:
  ...
  ""skills"": [
    {{
      ...
      ""actions"": [
        ...
        {{""type"":""body_hitbox"",""time"":[推論],""spawn_x"":[0=中心/正値=前方],""spawn_y"":[0.2〜1.1],""size_x"":[0.8〜2.0],""size_y"":[1.0〜2.0],""hit_count"":[1〜4],""active_time"":[推論]}}
      ]
    }},
    {{
      ""slot"": ""attack_b"",
