...
この名前から連想される【見た目（外見・体格・服装・武器・モチーフ）】と【戦い方・どんな技を使うか・間合い・強さの傾向】を想像し、features を作ってください。
...
- features: そのキャラを友達に紹介するような、平易で読みやすい日本語の文章（80〜140字）。**個性は『見た目』と『技・戦い方』だけで表現する**。見た目（外見・体格・服装・武器・モチーフ）と、戦い方・技（どんな攻撃をするか、間合い、強さの傾向＝耐久・速さ・攻撃力など）が自然に伝わるように書く。後でこの文章を素材に技を自動生成するので、見た目と技を具体的に書く。
...
- features の文章作法（重要。次の『悪い例』のような文体にしない）:
  ...
  ・良い例（こう書く）：「霧をまとった細身の僧侶。素早い手さばきで連続して打ち込むのが得意。体は丈夫ではないが、霧に隠れて間合いを取り、近づいて一気に攻める。」＝見た目と技を平易な言葉で短く具体的に。
