...
- recovery範囲: attack_a 0.14〜0.55、attack_b 0.20〜0.88、attack_c 0.30〜1.20、smash_side 0.20〜0.70。技連打が強すぎないよう、以前より少し長めにする
...
- action typeは melee_hitbox / projectile / area_hitbox / trap_hitbox / dash / jump_attack / push_enemy / pull_enemy / apply_status / buff_self / delay を使用可。
...
- 置き技は trap_hitbox を使い、duration 0.25〜0.8、size_x/size_y、spawn_x/spawn_y を必ず指定する。
  ...
  ""skills"": [
    {{
      ...
      ""actions"": [
        ...
        {{""type"":""melee_hitbox"",""time"":[推論],""range"":[0.7〜3.4],""spawn_x"":[0.6〜1.6],""spawn_y"":[0.1〜1.1],""size_y"":[0.7〜1.8],""hit_count"":1,""follow_owner"":true}}
      ]
    }},
    {{
      ""slot"": ""attack_b"",
    ...
    {{
      ...
      ""actions"": [
        {{""type"":""trap_hitbox"",""time"":[推論],""duration"":[0.25〜0.8],""spawn_x"":[0.8〜2.6],""spawn_y"":[0.05〜1.2],""size_x"":[0.8〜3.2],""size_y"":[0.5〜2.0],""hit_count"":1,""status"":""[属性に合う状態異常]"",""chance"":[推論]}}
      ]
    }},
    {{
      ""slot"": ""smash_side"",
