...
namespace PromptFighters.AI
{
    ...
    public static class AICharacterClient
    {
        ...
        static readonly string[] ConceptMotifs =
        {
            ...
            "もち", "唐辛子", "抹茶", "ラーメン", "キャンディ", "傘", "風船", "凧", "折り紙",
            "磁石", "ネオン", "レコード", "花火", "シャボン玉", "サボテン", "きのこ", "苔",
            "カメレオン", "ハチ", "タコ", "ペンギン", "カブトムシ", "フクロウ", "サメ", "ヤギ",
            "月", "虹", "台風", "砂時計", "灯台", "遊園地", "祭り", "書道", "銭湯", "電車"
        };
        static readonly string[] ConceptArchetypes =
        {
            ...
            "シェフ", "力士", "レーサー", "探偵", "消防士", "宇宙飛行士", "科学者", "庭師",
            "DJ", "書道家", "漁師", "大工", "郵便配達員", "サーカス団員", "登山家", "画家",
            "野球選手", "スケーター", "ゲーマー", "掃除屋", "占い師", "花屋"
        };
        // 武器・攻撃手段の種。剣・魔法ばかりに偏らないようにする。
        static readonly string[] ConceptWeapons =
        {
            "大剣", "双剣", "ハンマー", "弓", "大砲", "鞭", "傘", "杖", "槍", "鎌", "盾",
            "ヨーヨー", "ブーメラン", "チェーンソー", "素手の拳と蹴り", "鉤爪", "自分の尻尾",
            "楽器", "フライパンと料理道具", "釣り竿", "デッキブラシ", "風船", "凧", "巨大磁石",
            "絵筆", "サッカーボール", "太鼓", "扇子", "ロボットアーム", "ドリル", "レンチ",
            "分厚い本", "花束", "ダーツ", "縄", "スケートボード", "ぬいぐるみ", "口から吐く息"
        };
        // 体格の種。見た目のシルエットを散らす。
        static readonly string[] ConceptBuilds =
        {
        ...
        {
            "とても速いが打たれ弱い", "遅いが一撃がとても重い", "バランス型で扱いやすい",
            "ジャンプ力が高く空中戦が得意", "防御とカウンターが得意", "遠距離は強いが近距離が苦手",
            "近距離では無類に強いが飛び道具を持たない", "トリッキーで変則的な動きをする",
...
{{
  ...
  ""voice_profile"": {{
    ...
    ""voice_style"": ""[heroic/fierce/cool/mysterious/cheerful/elegant/eccentric/ominousのいずれか。性格・世界観に最も合う声質]"",
    ""instructions"": ""[日本語でキャラ固有のテンポ・感情・息遣い・間・声量変化を具体的に指定。性別・年齢・ピッチはここで再指定せず、プロ声優としてキャラクター本人になりきる方向で、実在人物の声真似は指定しない]"",
...
base_visual_prompt は外見の説明を英語で記述すること。髪色・服装・体格・武器・色合いなど視覚的特徴で説明すること。";
    }
}
