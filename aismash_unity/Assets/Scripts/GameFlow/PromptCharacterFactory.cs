    ...
    public static class PromptCharacterFactory
    {
        ...
        static SkillAction CloneAction(SkillAction a)
        {
            ...
            return new SkillAction
            {
                ...
                spawn_origin        = a.spawn_origin,
                spawn_anchor        = a.spawn_anchor,
                aim_mode            = a.aim_mode,
                vector_x            = a.vector_x,
                vector_y            = a.vector_y,
                rotation_angle      = a.rotation_angle,
                pattern             = a.pattern,
                pattern_count       = a.pattern_count,
                pattern_spacing     = a.pattern_spacing,
                pattern_radius      = a.pattern_radius,
                burst_interval      = a.burst_interval,
                telegraph_time      = a.telegraph_time,
                inner_radius        = a.inner_radius,
                arc_angle           = a.arc_angle,
                power               = a.power,
                ...
                explosion_radius    = a.explosion_radius,
                bounce_count        = a.bounce_count,
                wave_amplitude      = a.wave_amplitude,
                pierce              = a.pierce,
                split_count         = a.split_count,
                split_angle         = a.split_angle,
                orbit               = a.orbit,
                spawn_at_enemy      = a.spawn_at_enemy,
                status              = a.status,
                status_duration     = a.status_duration,
                chance              = a.chance,
                lifesteal_ratio     = a.lifesteal_ratio,
            };
        }
